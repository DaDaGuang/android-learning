        ...
        button1.setOnClickListener(new View.OnClickListener(){  //得到按钮的实例后，通过setOnClickListener方法为按钮注册一个监听器
            ...
            public  void onClick(View v){                       //点击按钮时就会执行监听器中的onClick方法，即Toast的功能需要在onClick中编写
                ...
                */
                ...
                /*2.5.1 standard
                Intent intent = new Intent(FirstActivity.this, SecondActivity.class);  //每点一次都会生成一个firstactivity实例，点几次就会在返回栈中存在几个实例
                startActivity(intent);*/

                //2.6.3 启动活动的最佳写法： SecondActivity的actionStart()来启动SecondActivity，并传递两个参数
